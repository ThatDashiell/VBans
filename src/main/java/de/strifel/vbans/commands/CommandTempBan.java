    ...
    public void execute(Invocation commandInvocation) {
        ...
        if (oPlayer.isPresent()) {
            ...
            if (!player.hasPermission("VBans.prevent") || commandSource instanceof ConsoleCommandSource) {
                ...
                if (database.addBan(player.getUniqueId().toString(), end, commandSource instanceof ConsoleCommandSource ? "Console" : ((Player) commandSource).getUniqueId().toString(), reason)) {
